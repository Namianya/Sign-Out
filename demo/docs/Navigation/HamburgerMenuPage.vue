    ...
    <section class="demo-section">
      ...
      <section>
        <mdb-container>
          ...
          <!--/.Navbar-->
          <!--Navbar-->
          <mdb-navbar expand="xl" class="mt-2" hamburger togglerIcon="angle-double-down" dark color="info" togglerIconClass="red-text">
            <!-- Navbar brand -->
            <mdb-navbar-brand class="text-white">Navbar</mdb-navbar-brand>
            <mdb-navbar-toggler>
              <mdb-navbar-nav right>
          ...
          <!--/.Navbar-->
          <!--Navbar-->
          <mdb-navbar expand="xl" class="mt-2 darken-4" hamburger togglerIcon="chevron-down" togglerSize="xs" dark color="amber">
            <!-- Navbar brand -->
            <mdb-navbar-brand class="text-white">Navbar</mdb-navbar-brand>
            <mdb-navbar-toggler>
              <mdb-navbar-nav right>
          ...
          <!--/.Navbar-->
          <!--Navbar-->
          <mdb-navbar expand="xl" hamburger  class="mt-2" togglerIcon="plus" dark color="danger" togglerIconClass="lime-text">
            <!-- Navbar brand -->
            <mdb-navbar-brand class="text-white">Navbar</mdb-navbar-brand>
            <mdb-navbar-toggler>
              <mdb-navbar-nav right>
